...
http.createServer(function (req, res) {
	...
	// 'sessionHits' : automatically created property that tells us how many hits a session has had
	// 'start' : when a session was started (moment.js object)
	// 'expiry' : when a session is set to expire (moment.js object)ter
	// 
