...
var sessionOptions = {
	...
	cookieSecret : 'what a lovely bunch of coconuts'	// The is the secret that session cookies will be signed with, change this!
};
...
function sign(session_id) {
	...
	// sign the cookies
	return session_id + '.' + crypto.createHmac('sha256', sessionOptions.cookieSecret)
		.update(session_id)
		.digest('base64')
		.replace(/=+$/, '');
}
